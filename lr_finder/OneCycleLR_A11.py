...
class OneCycleLR_A11:
    ...
    def __init__(self,
                 ...
                 annihilation_frac: float = 0.0, #0.1
                 reduce_factor: float = 1.0, #0.01
                 last_step: int = -1):
        # Sanity check
        ...
        #self.iterations = 50000/batch_size
        self.iterations = iterations
        self.num_steps = num_epochs * self.iterations
        self.steps_fifth_epoch = 5 * self.iterations
    ...
    def step(self):
        """Conduct one step of learning rate and momentum update"""
